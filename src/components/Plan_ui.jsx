  ...
  return (
    <section className={(plan==info.number)?"Active_plan":"plan"} onClick={()=>setPlan(info.number)}>
        ...
        <div className='plan_details' >
            <h3 className="title_heading_2">{info.name}</h3>
            <p className="subheading1">{info.price}</p>
            {(yearly)?<p className="subheading3">2 months free</p>:<></>}
        </div>
