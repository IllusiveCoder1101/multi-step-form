...
function Thanks_5() {
  ...
  return (
    <div className={(size<540)?'main5_mobile':"main5_desktop"}>
        ...
        <p className="subheading1">Thanks for confirming your subscription! We hope you have fun using our platform. If you ever need support, feel free to 
        email us at support@loremgaming.com.</p>
    </div>
  )
}

export default Thanks_5